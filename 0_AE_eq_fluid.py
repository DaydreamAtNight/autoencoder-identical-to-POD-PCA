...
summary(model, input_size=(101, 192080))
...
for i in range(start, end):
    ...
    i_images.append(flatten_data.T[:, i].cpu().detach().reshape(-1, 392, 490)+mean_data.reshape(1, 392, 490))
    o_images.append(reconstructs.T[:, i].cpu().detach().reshape(-1, 392, 490)+mean_data.reshape(1, 392, 490))
